...
<div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-12 col-lg-10 col-xl-8">
        <h2 class="h3 mb-4 page-title">Student Fee Category Amount Create</h2>
        <div class="my-4">
          <form method="POST" action="{{route('student.fee_category_amount.store')}}">
            @csrf
            <hr class="my-4">
            <div class="add_item">
              <div class="form-group ">
                <label for="inputState5">Fee Category</label>
                <select id="inputState5" name="fee_category_id" class="form-control @error ('fee_category_id') is-invalid @enderror">
