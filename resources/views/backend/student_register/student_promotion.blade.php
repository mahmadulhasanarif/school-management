...
<div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-12">
        <h2 class="page-title">Student Promotion Form</h2>
        <div class="row">
          <div class="col-md-12">
            <div class="card shadow mb-4">
              <div class="card-header">
                <strong class="card-title">Student Promotion Form</strong>
              </div>
              <div class="card-body">
                <form class="needs-validation" action="{{route('student.registration.promote', $data->student_id)}}" method="POST" enctype="multipart/form-data" novalidate>
                  @csrf
                  <div class="form-row">
